...
import { login as createUser } from "../../../services/authService";

function CreateUserDialog({ open, setOpenCreate, onCreated }) {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            if (res?.user) {
                ...
                if (temp)
                    toast.info(`Mật khẩu tạm thời: ${temp}`, {
                        autoClose: 6000,
                    });
                onCreated?.();
                setOpenCreate(false);
            ...
            <div className="w-full max-w-lg rounded-2xl bg-white shadow-lg">
                ...
                <form onSubmit={onSubmit} className="p-5 space-y-4">
                    ...
                    <div className="flex items-center justify-end gap-2 pt-2">
                        <button
                            type="button"
                            onClick={() => setOpenCreate((open) => !open)}
